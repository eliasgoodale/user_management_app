...
var GridColumnMenuSort = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    GridColumnMenuSort.prototype.sortIndex = function (field) {
        if (!this.props.sort) {
            return -1;
        }
        return this.props.sort.findIndex(function (s) { return s.field === field; });
    };
    /**
     * @hidden
     */
    ...
    GridColumnMenuSort.prototype.render = function () {
        ...
        var sortIndex = this.sortIndex(column.field);
        var sortedAsc = sort && sortIndex > -1 && sort[sortIndex].dir === ASC_DIR;
        var sortedDesc = sort && sortIndex > -1 && sort[sortIndex].dir === DESC_DIR;
        ...
        return (React.createElement(GridColumnMenuItemGroup_1.GridColumnMenuItemGroup, null,
            React.createElement(GridColumnMenuItem_1.GridColumnMenuItem, { title: localizationService.toLanguageString(messages_1.sortAscending, messages_1.messages[messages_1.sortAscending]), iconClass: 'k-i-sort-asc-sm', selected: sortedAsc, onClick: this.onAscClick }),
            React.createElement(GridColumnMenuItem_1.GridColumnMenuItem, { title: localizationService.toLanguageString(messages_1.sortDescending, messages_1.messages[messages_1.sortDescending]), iconClass: 'k-i-sort-desc-sm', selected: sortedDesc, onClick: this.onDescClick })));
    };
