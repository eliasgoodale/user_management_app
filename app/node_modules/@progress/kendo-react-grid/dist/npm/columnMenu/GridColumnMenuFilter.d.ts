...
export declare class GridColumnMenuFilter extends React.Component<GridColumnMenuFilterProps, GridColumnMenuFilterStateProps> {
     ...
     * @hidden
     */
    rootFilterOrDefault(rootFilter: CompositeFilterDescriptor | undefined): CompositeFilterDescriptor;
    /**
     * @hidden
     */
    filterGroupByField(field: string, filter: CompositeFilterDescriptor | undefined): CompositeFilterDescriptor | null;
    /**
     * @hidden
     */
